...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            HoleFiller fillingAlgo = new HoleFillerByBorder(connectivity, weightFunc);
            fillingAlgo.fillPixelsInHole(image);

            // Second Algorithm - Linear algorithm
            HoleFiller linearFillingAlgo = new LinearHoleFiller(connectivity, weightFunc);
//            linearFillingAlgo.fillPixelsInHole(image);

            ImageProcess.writeImageToFile(image, givenImagePath + "_o_" + epsilon + "_" + zed + "_" +
